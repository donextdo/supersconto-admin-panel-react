...
const Sidebar = () => {
    ...
    return (
        <div
            className={`${minimize ? 'w-16' : 'w-56'} fixed left-0 top-0 bottom-0 h-screen bg-green-900 flex flex-col gap-10 text-white`}>
            ...
            <li className={pathname=='/shop'? 'listItem active' :'listItem'}>
                ...
                {isAdmin && <li className={pathname == '/news' ? 'listItem active' : 'listItem'}>
                ...
                {isAdmin && <li className={pathname == '/orders' ? 'listItem active' : 'listItem'}>
                ...
                {isAdmin && <li className={pathname == '/vender' ? 'listItem active' : 'listItem'}>
